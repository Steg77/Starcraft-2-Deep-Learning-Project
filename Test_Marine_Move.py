...
class Move_Marine(base_agent.BaseAgent):
  """An agent for moving the marine to a point in the MoveToBeacon map."""

  def step(self, obs):
    super(Move_Marine, self).step(obs)
    if FUNCTIONS.Move_screen.id in obs.observation.available_actions:
      ...
      #print(beacon_center)
      return FUNCTIONS.Move_screen("now", beacon_center+(0.,20.))
    else:
